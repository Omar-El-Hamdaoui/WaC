...
function Test-ResourceState {
    ...
    try {
        ...
        # IMPORTANT : Forcer explicitement le type booléen
        $currentState._inDesiredState = [bool]$inDesiredState
        return $currentState
    }
    catch {
        ...
        return @{
            ...
            _inDesiredState = [bool]$false  # ← Forcer aussi ici
            error = $_.Exception.Message
        }
    }
}
